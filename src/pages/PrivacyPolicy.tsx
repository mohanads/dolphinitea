            ...
            <main className="container px-6 py-6 mx-auto flex-grow flex flex-col overflow-auto no-scrollbar">
                ...
                <ol className="flex flex-col gap-6">
                    <li>
                        ...
                        <p>Aberration Labs, Inc. (“Company”, “we”, “us”, or “our”) respects the privacy of our users (“you”). This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our InfiniTea App (“App”). By using the App, you consent to the data practices described in this policy.</p>
                    </li>
                    <li>
                        <h2 className="text-2xl font-semibold mb-2">2. Information We Collect</h2>
                        <p>We may collect information about you in a variety of ways. The information we may collect via the App includes: Personal Data: Personally identifiable information, such as your email address, that you voluntarily give to us when you register with the App. Derivative Data: Information our servers automatically collect when you access the App, such as your native actions that are integral to the App, as well as other interactions with the App and other users via server log files.</p>
                    </li>
                    <li>
                        <h2 className="text-2xl font-semibold mb-2">3. Use of Information Collected</h2>
                        <p>We use collected information to provide, operate, and maintain our App; to improve your experience with our App through personalized features and content; to understand and analyze how you use our App and to develop new products, services, features, and functionality.</p>
                    </li>
                    <li>
                        <h2 className="text-2xl font-semibold mb-2">4. Google Analytics, Smartlook & Clarity</h2>
                        <p>Our site uses Google Analytics and Microsoft Clarity to provide you with the best experience on our website while our app uses SmartLook to help understand how our users use the App. These services collect information such as how often users visit the App, what pages they visit, and what other sites they used prior to coming to the App. We use the information we get from these services only to improve our App. These services collect the IP address assigned to you on the date you visit the App, rather than your name or other identifying information. We make every effort to anonymize when possible, and this data is never shared with any third party.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <h2 className="text-2xl font-semibold mb-2">7. Policy for Children</h2>
                    ...
                    <li>
                        ...
                        <p>If you have questions or comments about this Privacy Policy, please contact us at <a href={`mailto:support@aberrationlabs.com`}>support@aberrationlabs.com</a></p>
                    </li>
                </ol>
            </main>
        </Layout>
