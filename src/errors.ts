export enum Code {
    ...
    SUPABASE_REGISTRATION_GAME_NAME_MISSING = 'ERR_SBS1005',
    SUPABASE_INVALID_REGISTRATION = 'ERR_SBS1006',
...
const messages = {
    ...
    [Code.SUPABASE_GUILD_ID_MISSING]: 'Supabase Guild ID missing',
    [Code.SUPABASE_UNKNOWN_ERROR]: 'Supabase unknown error occurred',
    [Code.SUPABASE_CONFIG_MISSING]: 'Supabase Guild Config is missing',
    [Code.SUPABASE_REGISTRATION_GAME_NAME_MISSING]: 'Supabase Registration Game Name is missing',
    [Code.SUPABASE_INVALID_REGISTRATION]: 'Supabase invalid Registration object',
...
const namespaces = {
    ...
    [Code.SUPABASE_REGISTRATION_GAME_NAME_MISSING]: Namespace.SUPABASE,
    [Code.SUPABASE_INVALID_REGISTRATION]: Namespace.SUPABASE,
