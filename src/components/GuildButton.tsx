...
export default (props: Props) => {
    ...
    return (
        <button
            onClick={onClick}
            type='button'
            className='p-4 transition bg-discord-black-70 border-2 border-infinitea-orange rounded-lg hover:bg-discord-black-60 transition hover:scale-103 active:scale-97'
        >
