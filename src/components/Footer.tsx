            ...
            <div className="mx-auto container px-6 py-4">
                <div className="md:flex md:justify-between">
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase">{i18n.t('Follow us')}</h2>
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase">{i18n.t('Legal')}</h2>
                            <ul className="text-gray-500 flex flex-col gap-4">
                                <li>
